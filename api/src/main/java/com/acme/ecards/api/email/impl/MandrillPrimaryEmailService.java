...
/**
 * Mandrill primary email service provider implementation.
 *
 * @author Sharmarke Aden (saden1)
 */
@Service
@RunLevel(ServiceLevel.STARTUP)
public class MandrillPrimaryEmailService implements EmailService, PrimaryService {

    private final Session session;
    private final EmailSender emailSender;

    @Inject
    MandrillPrimaryEmailService(@Named("mandrill") Session session, EmailSender emailSender) {
